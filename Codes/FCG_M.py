...
class FCG_M():
    ...
    def getCentroidsByUpdate(self,X, manually_choose = False,dic={}):
        ...
        for key in self.class_index_group_dic: 
            if manually_choose == False:     
               ...
               # print(manually_choose_dic[key])
                #print(self.train_new_embedding_fcg_fuzzy)
                random_controid = self.train_new_embedding_fcg_fuzzy[manually_choose_dic[key]]
    ...
    def do_FCG(self,class_num,class_index_group_dic,all_features_mapping_fuzzy,train_new_embedding_fcg_fuzzy, test_new_embedding_fcg_fuzzy,topology_distance_ratio = 2, lr = 1, sigma=1):
       ...
       # print(f"self.train_new_embedding_fcg_fuzzy {self.train_new_embedding_fcg_fuzzy}")
        ...
        self.getCentroidsByUpdate(  self.train_new_embedding_fcg_fuzzy,True,self.dic) #False
       ...
       # print(f"centeroid_dic {self.centeroid_dic}")
        ...
        self.test_new_embedding_fcg_fuzzy =test_new_embedding_fcg_fuzzy
      ...
      #  clf = TabNetClassifier() 
       # clf = MLPClassifier(solver= 'sgd',activation = 'tanh',learning_rate ='adaptive',hidden_layer_sizes =(2000,10)  )
        clf = DecisionTreeClassifier(criterion = 'log_loss', splitter ='random',max_depth = 80, min_samples_split=  0.01,min_samples_leaf = 2,min_weight_fraction_leaf = 0.001,max_features ='sqrt', max_leaf_nodes = 30)
