...
class Experiment():
        ...
        def InitializedExperimentDataList(self,
                                        ...
                                        max_f1_score_fcg,
                                        dic,class_num,class_index_group_dic,all_features_mapping_fuzzy,train_new_embedding_fcg_fuzzy,test_new_embedding_fcg_fuzzy
                                      ):
            ...
            #  KFold(n_splits=nfolder, random_state=None, shuffle=False)
              ...
              for train, test in kfold.split(dataread.all_data):
                  # print(f" dataread.all_data { dataread.all_data.shape}")
                   Comparision = FCG_M.FCG_M(
                        ...
                        dataread.label_all[test],topology_ratio,dic)     
              ...
              return max_accuracy_score_fcg,max_recall_score_fcg,max_precision_score_fcg,max_f1_score_fcg
                ...
                Comparision = FCG_M.FCG_M(
                        ...
                        dataread.label_test,topology_ratio,dic)                        


                Comparision.do_FCG(class_num,class_index_group_dic,all_features_mapping_fuzzy,train_new_embedding_fcg_fuzzy,test_new_embedding_fcg_fuzzy,topology_ratio)
        ...
        def Ttest( self, dataread, scope_num, topology_ratio, nfolder,dic,class_num,class_index_group_dic,all_features_mapping_fuzzy,train_new_embedding_fcg_fuzzy,test_new_embedding_fcg_fuzzy):
            ...
            while y <= scope_num:
                ...
                accuracy_score_fcg,recall_score_fcg,precision_score_fcg,f1_score_fcg =self.InitializedExperimentDataList(nfolder,
                                        ...
                                        topology_ratio,
                                         ...
                                         max_recall_score_fcg,
                                         max_precision_score_fcg,
                                         max_f1_score_fcg ,dic  ,class_num,class_index_group_dic,all_features_mapping_fuzzy,train_new_embedding_fcg_fuzzy,test_new_embedding_fcg_fuzzy           
                                        )      
